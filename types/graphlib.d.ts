// Typescript definition file for graphlib. Originally from DefinitelyTyped
// updated by amaurymartiny on github, plus some additional modifications by myself
// See https://github.com/dagrejs/graphlib/pull/98
...
declare module 'graphlib' {
  ...
  export class Graph<GraphLabel = string, NodeLabel = string, EdgeLabel = string> {
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setGraph(label: GraphLabel): Graph<NodeLabel, EdgeLabel>;
